...
const question2 = document.querySelector('#questionnaire_2')
const question3 = document.querySelector('#questionnaire_3')
const question4 = document.querySelector('#questionnaire_4')
const question5 = document.querySelector('#questionnaire_5')
    ...
    setInterval(async () => {
       ...
       question1.onclick = function () {
        ...
        question2.onclick = function () {
          localStorage.setItem('q2', Object.keys(info).reduce(function(a, b){ return info[a] > info[b] ? a : b }))
        }
        question3.onclick = function () {
          localStorage.setItem('q3', Object.keys(info).reduce(function(a, b){ return info[a] > info[b] ? a : b }))
        }
        question4.onclick = function () {
          localStorage.setItem('q4', Object.keys(info).reduce(function(a, b){ return info[a] > info[b] ? a : b }))
        }
        question5.onclick = function () {
          localStorage.setItem('q5', Object.keys(info).reduce(function(a, b){ return info[a] > info[b] ? a : b }))
        }
